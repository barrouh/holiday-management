...
import com.everis.domain.Contact;
import com.everis.domain.MailException;
import com.everis.domain.Settings;
...
public class MailServiceImpl {
	...
	static final Logger LOGGER = LogManager.getLogger(MailServiceImpl.class);

	public MailServiceImpl(Settings settings) {
