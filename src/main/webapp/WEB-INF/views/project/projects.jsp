    ...
    <%@ include file="/WEB-INF/views/include.jsp"%>
        ...
        <div class="uk-section uk-section-xsmall uk-section-muted uk-animation-fade">
            <div class="uk-container uk-container-large uk-width-5-6 uk-section-default uk-box-shadow-medium uk-padding">
                <div>
                    <a href="#" class="uk-icon-link uk-margin-small-right uk-align-right" uk-icon="icon: plus-circle; ratio: 2" uk-tooltip="Add a new project"></a>
                                ...
                                <c:forEach items="${projects}" var="project">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="uk-text-truncate"><a href="editProject?idproject=${project.idProject}" class="uk-icon-link uk-margin-small-right" uk-icon="file-edit" uk-tooltip="Edit">Edit</a> <a href="deleteProject?idproject=${project.idProject}" class="uk-icon-link" uk-icon="trash" uk-tooltip="Delete">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </c:forEach>
