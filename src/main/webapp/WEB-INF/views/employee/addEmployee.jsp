        ...
        <section class="uk-section uk-section-muted uk-animation-fade">
            ...
            <hr>
                ...
                <form method="POST" action="" class="">
                    ...
                    <div class="uk-margin">
                        <input class="uk-input" name="lastname" type="text" placeholder="<spring:message code="employee.last.name" />">
                    </div>
                    <div class="uk-margin">
                        <input class="uk-input" name="username" type="text" placeholder="<spring:message code="employee.user.name" />">
                    </div>
                    <div class="uk-margin">
