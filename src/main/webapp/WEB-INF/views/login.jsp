...
<section class="uk-section uk-section-muted uk-animation-fade ">
	<div
		class="uk-container uk-container-small uk-box-shadow-xlarge uk-padding">
		<h5 class="uk-heading-line uk-text-center"
			id="login-form-text-personal">LOG IN to Holiday Management</h5>
		<form method="POST" action="/login" class="">
			<div class="uk-margin ">
				<input class="uk-input uk-width-1-3 uk-align-center"
					id="login-user-personal" type="text" placeholder="User name">
			</div>
			<div class="uk-margin ">
				<input class="uk-input uk-width-1-3 uk-align-center" type="password"
